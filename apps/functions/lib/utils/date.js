...
exports.toJstStartOfDay = toJstStartOfDay;
exports.toJstEndOfDay = toJstEndOfDay;
exports.getWeekStart = getWeekStart;
exports.getWeekEnd = getWeekEnd;
exports.getCurrentJstDateString = getCurrentJstDateString;
/**
 * JSTの指定日の開始時刻を生成
 * @param date 日付文字列 (YYYY-MM-DD) または Date オブジェクト
 * @returns JSTの開始時刻
 */
function toJstStartOfDay(date) {
